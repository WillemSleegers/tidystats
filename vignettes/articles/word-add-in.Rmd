...
resource_files:
  - example.mp4
vignette: >
  %\VignetteIndexEntry{Microsoft Word add-in}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

The tidystats Microsoft Word add-in can be used to report statistics in a Microsoft Word
...
The tidystats Microsoft Word add-in is available in the Office Add-in store. You can find
...
![Screenshot of the tidystats Microsoft Word add-in showing a list of analyses with statistics](screenshot.png)
