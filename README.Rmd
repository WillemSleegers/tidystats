...
The file created with the `write_stats()` function can be used in an add-in for Microsoft Word to report the statistics. An add-in for Google Docs is also available, but only through manual installation.  For more information on 
these add-ins, please see their GitHub pages:
