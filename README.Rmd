...
`r badge_doi("10.5281/zenodo.4041859", "yellow")`

```{r, echo = FALSE, results='asis'}
cat(
	badge_cran_release("tidystats", "blue"),
...
`tidystats` extracts the output of statistical models (e.g., *t*-tests,
regression models) and combines them into a structured file. This file can then 
be used to report the statistics in a manuscript or shared with others so that 
they can extract the statistics (e.g., for meta-analyses).
...
from Github using [devtools](https://github.com/r-lib/devtools). 
...
statistical models. You can name the list whatever you want (in the 
...
This results is a .json file that contains all the statistics from the three 
...
If you want to report the statistics in a manuscript, you can do so with a
Word add-in that is currently in development [here](https://github.com/WillemSleegers/tidystats-Word-add-in).

## More resources

Do you have questions or comments about `tidystats`? Create an issue here on
Github or contact me via [Twitter](https://twitter.com/willemsleegers).