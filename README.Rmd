...
`tidystats` is an R package to easily create a text file containing the output 
of statistical models. The goal of this package is to help researchers accompany 
...
Optionally you can also add an identifier and additional notes using the 
`identifier` and `notes` arguments.
