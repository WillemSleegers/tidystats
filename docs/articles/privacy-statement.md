...
tidystats, simply let me know by creating a [GitHub
issue](https://github.com/WillemSleegers/tidystats/issues) or sending an
[e-mail](mailto:tidystats@gmail.com).

Note that Posit does [track](https://cran-logs.rstudio.com) how many
times R packages are downloaded from CRAN, and Microsoft does similar
tracking for Office add-ins.
