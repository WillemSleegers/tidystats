...
you can inspect it
[here](https://github.com/WillemSleegers/tidystats/blob/master/tests/data/main.json).
...
the [tidystats website](https://tidystats.io/) or their GitHub pages:
...
such as a FAQ, tips and tricks, as well as how to receive (and give)
support.
