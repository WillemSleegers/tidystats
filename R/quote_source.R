...
#'
#' Data of the replication of Lorge & Curtiss (1936) from the Many Labs project
#' (Klein et al., 2014).
#'
...
#' Jefferson than Lenin. In the replication study, the quotation was attributed 
#' to either George Washington, the liked individual, or Osama Bin Laden, the 
#' disliked individual.
#' 
#' @references 
#' Lorge, I., & Curtiss, C. C. (1936). Prestige, suggestion, and attitudes. 
#' The Journal of Social Psychology, 7, 386-402. 
#' \url{http://dx.doi.org/10.1080/00224545.1936}
#' 
